ALTER TABLE "~Config"
   ...
   ALTER TABLE "RoundType"
   ALTER COLUMN label_fr TYPE character varying(50);
   
      ALTER TABLE "Sport" ADD COLUMN no_pic boolean;
   ALTER TABLE "Championship" ADD COLUMN no_pic boolean;
   ALTER TABLE "State" ADD COLUMN no_pic boolean;
   ALTER TABLE "Olympics" ADD COLUMN no_pic boolean;
   ALTER TABLE "Country" ADD COLUMN no_pic boolean;
   ALTER TABLE "Team" ADD COLUMN no_pic boolean;
   ALTER TABLE "Event" ADD COLUMN no_pic boolean;
...
begin
	...
	'SELECT
		...
		RS.comment AS rs_comment, RS.exa AS rs_exa, YR.id AS yr_id, YR.label AS yr_label, CX1.id AS cx1_id, CX1.label AS cx1_label, CX1.label AS cx1_label_en, CX2.id AS cx2_id, CX2.label AS cx2_label, CX2.label AS cx2_label_en,
...
begin
	...
	'SELECT
		RD.id AS rd_id, RD.id_result_type AS rd_result_type, RT.id AS rt_id, RT.label' || _lang || ' AS rt_label, RT.index AS rt_index, RD.result1 AS rd_result1, RD.result2 AS rd_result2, RD.result3 AS rd_result3, RD.date AS rd_date, RD.exa AS rd_exa, RD.comment AS rd_comment,
		CX.id AS cx_id, CX.label AS cx_label, CX.label AS cx_label_en, CT1.id AS ct1_id, CT1.label' || _lang || ' AS ct1_label, CT1.label AS ct1_label_en, ST1.id AS st1_id, ST1.code AS st1_code, ST1.label AS st1_label_en, CN1.id AS cn1_id, CN1.code AS cn1_code, CN1.label AS cn1_label_en,
		CT2.id AS ct2_id, CT2.label' || _lang || ' AS ct2_label, CT2.label AS ct2_label_en, ST2.id AS st2_id, ST2.code AS st2_code, ST2.label AS st2_label_en, CN2.id AS cn2_id, CN2.code AS cn2_code, CN2.label AS cn2_label_en' ||
		_columns || '
	FROM
		"Round" RD
...
begin
	...
	'SELECT
		...
		CX.id AS cx_id, CX.label AS cx_label, CX.label AS cx_label_en, CT.id AS ct_id, CT.label' || _lang || ' AS ct_label_en, CT.label AS ct_label, ST.id AS st_id, ST.code AS st_code, ST.label' || _lang || ' AS st_label, ST.label AS st_label_en,
...
begin
	...
	'SELECT
		...
		RS.comment AS rs_comment, RS.exa AS rs_exa, YR.id AS yr_id, YR.label AS yr_label, CX.id AS cx_id, CX.label AS cx_label, CX.label AS cx_label_en,
...
$BODY$
  ...
  insert into "~Config" values ('USL_CHAMP_EVENTS', '455,532,572,621', NULL);
insert into "~Config" values ('USL_CHAMP_SUBEVENTS', '452,453,454,573,624,530', NULL);
