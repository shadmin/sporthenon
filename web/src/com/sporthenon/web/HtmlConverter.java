...
public class HtmlConverter {
	...
	public static String getPlace(Integer idcx, Integer idct, Integer idst, Integer idcn, String cx, String ct, String st, String cn, String cxEN, String ctEN, String stEN, String cnEN, String yr) {
		...
		sb.append(",&nbsp;" + HtmlUtils.writeLink(Country.alias, idcn, cn, cnEN)); 
	...
	public static StringBuffer getHeader(HttpServletRequest request, short type, Collection<Object> params, Contributor cb, String lang) throws Exception {
		...
		if (type == HEADER_RESULTS) {
			...
			hHeader.put("title", s1 + (!is1Date ? " – " + s2 : ""));
			...
			hHeader.put("item1", HtmlUtils.writeDateLink(dt1, s1) + (!is1Date ? HtmlUtils.RARROW + HtmlUtils.writeDateLink(dt2, s2) : ""));
		}
	...
	public static StringBuffer getRecordInfo(HttpServletRequest request, String type, int id, String lang) throws Exception {
		...
		if (type.equals(Athlete.alias)) {
			...
			if (StringUtils.notEmpty(r.getDate2()))
				html.append("<tr><th class='caption'>" + ResourceUtils.getText(StringUtils.notEmpty(r.getDate1()) ? "dates" : "date", lang) + "</th><td>" + (StringUtils.notEmpty(r.getDate1()) ? HtmlUtils.writeDateLink(r.getDate1(), StringUtils.toTextDate(r.getDate1(), lang, "d MMMM yyyy")) + "&nbsp;&ndash;&nbsp;" : "") + HtmlUtils.writeDateLink(r.getDate2(), StringUtils.toTextDate(r.getDate2(), lang, "d MMMM yyyy")) + "</td></tr>");
			...
			if (l != null && l.size() > 1) {
				...
				html.append("<table style='margin-bottom:0px;'><thead><tr><th>" + HtmlUtils.writeToggleTitle(ResourceUtils.getText("entity.YR", lang).toUpperCase(), false) + "</th></tr></thead><tbody class='tby'>");
			...
			if (lRounds != null && !lRounds.isEmpty()) {
				...
				if (rdlistHtml.length() > 0) {
					html.append("<table style='margin-bottom:0px;'><thead><tr><th>" + HtmlUtils.writeToggleTitle(ResourceUtils.getText("entity.RD", lang).toUpperCase(), false) + "</th></tr></thead><tbody class='tby'>");
			...
			hInfo.put("name" + (vNm.size() > 1 && !StringUtils.notEmpty(e.getYear1()) ? "s" : ""), "<b>" + (StringUtils.notEmpty(e.getYear1()) ? e.getLabel().toUpperCase() : sbTm.toString()) + "</b>");
		...
		for (Object obj : coll) {
			...
			if (!en.equals(currentEntity)) {
				...
				if (en.equals(City.alias))
					...
					cols.append("<th/><th onclick='sort(\"" + id + "\", this, 0);'>" + ResourceUtils.getText("sport", lang) + "</th><th onclick='sort(\"" + id + "\", this, 1);'>" + ResourceUtils.getText("event", lang) + "</th><th onclick='sort(\"" + id + "\", this, 2);'>" + ResourceUtils.getText("year", lang)  + "</th>" + (etype.matches(Athlete.alias + "|" + Team.alias + "|" + Country.alias) ? "<th onclick='sort(\"" + id + "\", this, 3);'>" + ResourceUtils.getText("rank", lang) + "</th>" : "") + "<th onclick='sort(\"" + id + "\", this, 4);'>" + ResourceUtils.getText("rank.1", lang) + "</th><th onclick='sort(\"" + id + "\", this, 5);'>" + ResourceUtils.getText("rank.2", lang) + "</th><th onclick='sort(\"" + id + "\", this, 6);'>" + ResourceUtils.getText("rank.3", lang) + "</th>");
			...
			if (en.equals(Athlete.alias)) {
				...
				String path1 = item.getLabelRel1() + "&nbsp;–&nbsp;" + item.getLabelRel3() + "&nbsp;–&nbsp;" + item.getLabelRel5() + (item.getIdRel4() != null ? "&nbsp;–&nbsp;" + item.getLabelRel7() : "") + (item.getIdRel5() != null ? "&nbsp;–&nbsp;" + item.getLabelRel9() : "");
				...
				c5 = tEntity[0] + (isScore ? "<div class='refscore'>" + StringUtils.formatResult(item.getTxt1(), lang) + "</div>" : "");
			...
			if (isExport || !isAllRef || count < ITEM_LIMIT) {
				...
				html.append((c3 != null ? "<td class='srt'>" + c3 + "</td>" : "") + (c4 != null ? "<td class='srt'" + (c4.contains("'highlight'") ? " style='background-color:yellow;'" : "") + ">" + c4 + "</td>" : ""));
				html.append((c5 != null ? "<td class='srt'" + (c5.contains("'highlight'") ? " style='background-color:yellow;'" : "") + ">" + c5 + "</td>" : "") + (c6 != null ? "<td class='srt'" + (c4.contains("'highlight'") ? " style='background-color:yellow;'" : "") + ">" + c6 + "</td>" : ""));
				html.append((c7 != null ? "<td class='srt'" + (c7.contains("'highlight'") ? " style='background-color:yellow;'" : "") + ">" + c7 + "</td>" : "") + "</tr>");
			}
			count++;
		}
		if (limit != null && !limit.equalsIgnoreCase("ALL") && count >= Integer.parseInt(limit)) {
	...
	public static StringBuffer convertResults(Collection<Object> coll, Championship cp, Event ev, Contributor m, String lang) throws Exception {
		...
		for (Object obj : coll) {
			...
			String dates = (StringUtils.notEmpty(bean.getRsDate1()) ? HtmlUtils.writeDateLink(bean.getRsDate1(), StringUtils.toTextDate(bean.getRsDate1(), lang, "d MMM")) + HtmlUtils.RARROW : "") + (StringUtils.notEmpty(bean.getRsDate2()) ? HtmlUtils.writeDateLink(bean.getRsDate2(), StringUtils.toTextDate(bean.getRsDate2(), lang, "d MMM")) : "");
		...
		for (Object obj : coll) {
			...
			if (currentEntity == null || !item.getEntity().equals(currentEntity)) {
				...
				if (item.getEntity().equals(Result.alias))
					html.append("<th onclick='sort(\"" + id + "\", this, 0);'>" + ResourceUtils.getText("sport", lang) + "</th><th onclick='sort(\"" + id + "\", this, 1);'>" + ResourceUtils.getText("event", lang) + "</th><th onclick='sort(\"" + id + "\", this, 2);'>" + ResourceUtils.getText("year", lang)  + "</th>" + "<th onclick='sort(\"" + id + "\", this, 4);'>" + ResourceUtils.getText("rank.1", lang) + "</th><th onclick='sort(\"" + id + "\", this, 5);'>" + ResourceUtils.getText("rank.2", lang) + "</th><th onclick='sort(\"" + id + "\", this, 6);'>" + ResourceUtils.getText("rank.3", lang) + "</th><th onclick='sort(\"" + id + "\", this, 7);'>" + ResourceUtils.getText("date", lang) + "</th>");
				else
			...
			String event = "<a href='" + HtmlUtils.writeURL("/results", item.getIdRel2() + "-" + item.getIdRel3() + (item.getIdRel4() != null ? "-" + item.getIdRel4() : "") + (item.getIdRel5() != null ? "-" + item.getIdRel5() : "") + (item.getIdRel18() != null ? "-" + item.getIdRel18() : ""), item.getLabelRel12() + "/" + item.getLabelRel13() + (item.getIdRel4() != null ? "/" + item.getLabelRel14() : "") + (item.getIdRel5() != null ? "/" + item.getLabelRel15() : "") + (item.getIdRel18() != null ? "/" + item.getLabelRel16() : "")) + "'>" + (item.getLabelRel3() + (item.getIdRel4() != null ? "&nbsp;–&nbsp;" + item.getLabelRel4() : "") + (item.getIdRel5() != null ? "&nbsp;–&nbsp;" + item.getLabelRel5() : "") + (item.getIdRel18() != null ? "&nbsp;–&nbsp;" + item.getLabelRel18() : "")) + "</a>";
			String dates = (StringUtils.notEmpty(item.getDate1()) ? HtmlUtils.writeDateLink(item.getDate1(), StringUtils.toTextDate(item.getDate1(), lang, "d MMMM yyyy")) + HtmlUtils.RARROW : "") + (StringUtils.notEmpty(item.getDate2()) ? HtmlUtils.writeDateLink(item.getDate2(), StringUtils.toTextDate(item.getDate2(), lang, "d MMMM yyyy")) : "");
			String alias = item.getComment();
			if (item.getEntity().equals(Result.alias)) { // Past events
				...
				StringBuffer result = new StringBuffer("<td style='font-weight:bold;'>" + tEntity[0] + "</td>");
				result.append("<td>" + (StringUtils.notEmpty(tEntity[1]) ? tEntity[1] : "") + "</td>");
				result.append("<td>" + (StringUtils.notEmpty(tEntity[2]) ? tEntity[2] : "") + "</td>");
				html.append("<tr><td class='srt'>" + sport + "</td><td class='srt'>" + event + "</td>");
				html.append("<td class='srt'>" + year + "</td>" + result.toString() + "<td>" + dates + "</td></tr>");
			}
			else { // Future events
				String place = (item.getIdRel6() != null ? HtmlUtils.writeLink(Complex.alias, item.getIdRel6(), item.getLabelRel6() + ", " + item.getLabelRel7(), item.getLabelRel9()) : HtmlUtils.writeLink(City.alias, item.getIdRel8(), item.getLabelRel8(), item.getLabelRel11()));
				html.append("<tr><td class='srt'>" + sport + "</td><td class='srt'>" + event + "</td>");
				html.append("<td>" + dates + "</td><td>" + place + "</td></tr>");
			}
		}
		html.append("</tbody></table>");
		return html;
	...
	public static StringBuffer convertUSChampionships(Collection<Object> coll, String lang) throws Exception {
		...
		for (Object obj : coll) {
			...
			String year = HtmlUtils.writeLink(Year.alias, bean.getYrId(), bean.getYrLabel(), null);
			String date = (StringUtils.notEmpty(bean.getRsDate1()) ? HtmlUtils.writeDateLink(bean.getRsDate1(), StringUtils.toTextDate(bean.getRsDate1(), lang, null)) + "&nbsp;&ndash;&nbsp;" : "") + (StringUtils.notEmpty(bean.getRsDate2()) ? HtmlUtils.writeDateLink(bean.getRsDate2(), StringUtils.toTextDate(bean.getRsDate2(), lang, null)) : StringUtils.EMPTY);
	...
	public static StringBuffer convertUSRecords(Collection<Object> coll, String lang) throws Exception {
		...
		for (Object obj : coll) {
			...
			tDate[0] = (tDate[0] != null && tDate[0].matches("\\d\\d\\/\\d\\d\\/\\d\\d\\d\\d") ? HtmlUtils.writeDateLink(tDate[0], StringUtils.toTextDate(tDate[0], lang, "MMM dd, yyyy")) : tDate[0].replaceAll("\\-", "–"));
			tDate[1] = (tDate[1] != null && tDate[1].matches("\\d\\d\\/\\d\\d\\/\\d\\d\\d\\d") ? HtmlUtils.writeDateLink(tDate[1], StringUtils.toTextDate(tDate[1], lang, "MMM dd, yyyy")) : tDate[1].replaceAll("\\-", "–"));
			tDate[2] = (tDate[2] != null && tDate[2].matches("\\d\\d\\/\\d\\d\\/\\d\\d\\d\\d") ? HtmlUtils.writeDateLink(tDate[2], StringUtils.toTextDate(tDate[2], lang, "MMM dd, yyyy")) : tDate[2].replaceAll("\\-", "–"));
			tDate[3] = (tDate[3] != null && tDate[3].matches("\\d\\d\\/\\d\\d\\/\\d\\d\\d\\d") ? HtmlUtils.writeDateLink(tDate[3], StringUtils.toTextDate(tDate[3], lang, "MMM dd, yyyy")) : tDate[3].replaceAll("\\-", "–"));
			tDate[4] = (tDate[4] != null && tDate[4].matches("\\d\\d\\/\\d\\d\\/\\d\\d\\d\\d") ? HtmlUtils.writeDateLink(tDate[4], StringUtils.toTextDate(tDate[4], lang, "MMM dd, yyyy")) : tDate[4].replaceAll("\\-", "–"));
