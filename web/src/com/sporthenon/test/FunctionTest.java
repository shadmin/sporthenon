...
public class FunctionTest extends TestCase {
	...
	public void testCountRef() throws Exception {
		Collection<Object> col = DatabaseHelper.executeNative("SELECT * FROM \"CountRef\"('PR', 1)");
		assertNotNull(col);
...
//			System.out.println(obj);
	...
	public void testCalendarResults() throws Exception {
		ArrayList<Object> params = new ArrayList<Object>();
		params.add(new String("19100101"));
		params.add(new String("19120201"));
		params.add(new Integer(0));
		params.add(new String("_fr"));
		Collection col = DatabaseHelper.call("GetCalendarResults", params);
		assertNotNull(col);
		assertTrue(col.size() > 0);
		ArrayList<Object> lst = new ArrayList<Object>(col);
		assertTrue(lst.get(0) instanceof RefItem);
...
//			System.out.println(obj);
	...
	public void testRetiredNumber() throws Exception {
		...
		Collection col = DatabaseHelper.call("GetRetiredNumbers", params);
		assertNotNull(col);
		assertTrue(col.size() > 0);
		ArrayList<Object> lst = new ArrayList<Object>(col);
...
//			System.out.println(obj);
	...
	public void testTeamStadium() throws Exception {
		...
		params.add(new String("0"));
		params.add(new String(""));
		Collection col = DatabaseHelper.call("GetTeamStadiums", params);
		assertNotNull(col);
		assertTrue(col.size() > 0);
		ArrayList<Object> lst = new ArrayList<Object>(col);
