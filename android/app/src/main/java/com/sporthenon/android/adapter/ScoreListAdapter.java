...
public class ScoreListAdapter extends BaseAdapter {
	...
	public ScoreListAdapter(Context context, List<ResultItem> list) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.year = (TextView) convertView.findViewById(R.id.scyear);
			holder.line1 = (LinearLayout) convertView.findViewById(R.id.scline1);
			holder.img1 = (ImageView) convertView.findViewById(R.id.scimg1);
			holder.txt1 = (TextView) convertView.findViewById(R.id.sctxt1);
			holder.line2 = (LinearLayout) convertView.findViewById(R.id.scline2);
			holder.img2 = (ImageView) convertView.findViewById(R.id.scimg2);
			holder.txt2 = (TextView) convertView.findViewById(R.id.sctxt2);
			holder.score = (TextView) convertView.findViewById(R.id.scscore);
		...
		holder.score.setText(ri.getResult1());
		return convertView;
	}
