ALTER TABLE _ref_item
    ALTER COLUMN entity TYPE character varying(3);
    
-- FUNCTION: public.entity_ref(character varying, integer, character varying, character varying, integer, character varying)

-- DROP FUNCTION public.entity_ref(character varying, integer, character varying, character varying, integer, character varying);
...
ALTER FUNCTION public.entity_ref(character varying, integer, character varying, character varying, integer, character varying)
    OWNER TO shadmin;
