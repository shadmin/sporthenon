...
<div class="fieldset" style="text-align:center;width:300px;">
	...
	<div>
		<table class="tlogin">
			<tr>
				<th><%=StringUtils.text("loginid", session)%> :</th><td><input type="text" id="login" name="login" size="15" onkeydown="if(event.keyCode==13){$('flogin').submit();}"/></td>
			</tr>
			<tr>
	...
	<table>
		...
		<tr>
			...
			<%
				...
				Collection<PicklistItem> cPicklist = DatabaseManager.getPicklist("SELECT id, label FROM sport", null);
