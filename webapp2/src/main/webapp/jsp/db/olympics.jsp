...
<%
	...
	Collection<PicklistItem> cPicklist = DatabaseManager.getPicklist("SELECT id FROM olympics ORDER BY id", null);
	...
	cPicklist = DatabaseManager.getPicklist("SELECT id FROM sport ORDER BY id", null);
	for (PicklistItem plb : cPicklist) {
