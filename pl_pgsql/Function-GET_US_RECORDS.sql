-- Function: "GET_US_RECORDS"(integer, text, text, text, text, character varying)

-- DROP FUNCTION "GET_US_RECORDS"(integer, text, text, text, text, character varying);

CREATE OR REPLACE FUNCTION "GET_US_RECORDS"(_id_championship integer, _events text, _subevents text, _types1 text, _types2 text, _lang character varying)
