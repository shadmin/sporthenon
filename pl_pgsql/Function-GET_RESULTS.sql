-- Function: "GET_RESULTS"(integer, integer, integer, integer, integer, text, character varying)

-- DROP FUNCTION "GET_RESULTS"(integer, integer, integer, integer, integer, text, character varying);
