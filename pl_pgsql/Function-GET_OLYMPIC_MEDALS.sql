-- Function: "GET_OLYMPIC_MEDALS"(text, integer, text, text, text, character varying)

-- DROP FUNCTION "GET_OLYMPIC_MEDALS"(text, integer, text, text, text, character varying);
