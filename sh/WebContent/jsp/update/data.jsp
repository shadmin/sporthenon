	...
	<div class="fieldset">
		...
		<div class="fscontent" style="height:auto;">
			...
			<table id="table-PR" style="display:none;">
				...
				<tr><th>Last Name</th><td><input type="text" id="pr-lastname"/></td></tr>
				<tr><th>First Name</th><td><input type="text" id="pr-firstname"/></td></tr>
			...
			<table id="table-CP" style="display:none;">
				...
				<tr><th>Label (EN)</th><td><input type="text" id="cp-label"/></td></tr>
				<tr><th>Label (FR)</th><td><input type="text" id="cp-labelfr"/></td></tr>
				<tr><th>Index</th><td><input type="text" id="cp-index"/></td></tr>
			</table>
			<!-- CITY -->
			<table id="table-CT" style="display:none;">
				<tr><th>ID</th><td><input type="text" disabled="disabled" id="ct-id" class="id"/></td></tr>
				<tr><th>Label (EN)</th><td><input type="text" id="ct-label"/></td></tr>
			...
			<table id="table-CN" style="display:none;">
				...
				<tr><th>Label (EN)</th><td><input type="text" id="cn-label"/></td></tr>
				<tr><th>Label (FR)</th><td><input type="text" id="cn-labelfr"/></td></tr>
				<tr><th>Code</th><td><input type="text" id="cn-code"/></td></tr>
			</table>
			<!-- EVENT -->
			<table id="table-EV" style="display:none;">
				<tr><th>ID</th><td><input type="text" disabled="disabled" id="ev-id" class="id"/></td></tr>
				<tr><th>Label (EN)</th><td><input type="text" id="ev-label"/></td></tr>
				<tr><th>Label (FR)</th><td><input type="text" id="ev-labelfr"/></td></tr>
				<tr><th>Type</th><td><input type="hidden" id="ev-type"/><input type="text" id="ev-type-l"/></td></tr>
				<tr><th>Index</th><td><input type="text" id="ev-index"/></td></tr>
			</table>
			<!-- OLYMPICS -->
			<table id="table-OL" style="display:none;">
				<tr><th>ID</th><td><input type="text" disabled="disabled" id="ol-id" class="id"/></td></tr>
				<tr><th>Year</th><td><input type="hidden" id="ol-year"/><input type="text" id="ol-year-l"/></td></tr>
				<tr><th>City</th><td><input type="hidden" id="ol-city"/><input type="text" id="ol-city-l"/></td></tr>
				<tr><th>Type</th><td><input type="text" id="ol-type"/></td></tr>
				<tr><th>Start</th><td><input type="text" id="ol-start"/></td></tr>
				<tr><th>End</th><td><input type="text" id="ol-end"/></td></tr>
				<tr><th>Sports</th><td><input type="text" id="ol-sports"/></td></tr>
				<tr><th>Events</th><td><input type="text" id="ol-events"/></td></tr>
				<tr><th>Countries</th><td><input type="text" id="ol-countries"/></td></tr>
				<tr><th>Athletes</th><td><input type="text" id="ol-persons"/></td></tr>
			</table>
			<!-- SPORT -->
			<table id="table-SP" style="display:none;">
				<tr><th>ID</th><td><input type="text" disabled="disabled" id="sp-id" class="id"/></td></tr>
				<tr><th>Label (EN)</th><td><input type="text" id="sp-label"/></td></tr>
				<tr><th>Label (FR)</th><td><input type="text" id="sp-labelfr"/></td></tr>
				<tr><th>Type</th><td><input type="text" id="sp-type"/></td></tr>
				<tr><th>Index</th><td><input type="text" id="sp-index"/></td></tr>
			</table>
			<!-- STATE -->
			<table id="table-ST" style="display:none;">
				<tr><th>ID</th><td><input type="text" disabled="disabled" id="st-id" class="id"/></td></tr>
				<tr><th>Label (EN)</th><td><input type="text" id="st-label"/></td></tr>
				<tr><th>Label (FR)</th><td><input type="text" id="st-labelfr"/></td></tr>
				<tr><th>Code</th><td><input type="text" id="st-code"/></td></tr>
				<tr><th>Capital</th><td><input type="text" id="st-capital"/></td></tr>
			</table>
			<!-- TEAM -->
			<table id="table-TM" style="display:none;">
				<tr><th>ID</th><td><input type="text" disabled="disabled" id="tm-id" class="id"/></td></tr>
				<tr><th>Label</th><td><input type="text" id="tm-label"/></td></tr>
				<tr><th>Sport</th><td><input type="hidden" id="tm-sport"/><input type="text" id="tm-sport-l"/></td></tr>
				<tr><th>Country</th><td><input type="hidden" id="tm-country"/><input type="text" id="tm-country-l"/></td></tr>
				<tr><th>League</th><td><input type="hidden" id="tm-league"/><input type="text" id="tm-league-l"/></td></tr>
				<tr><th>Conference</th><td><input type="text" id="tm-conference"/></td></tr>
				<tr><th>Division</th><td><input type="text" id="tm-division"/></td></tr>
				<tr><th>Comment</th><td><input type="text" id="tm-comment"/></td></tr>
				<tr><th>From</th><td><input type="text" id="tm-year1"/></td></tr>
				<tr><th>To</th><td><input type="text" id="tm-year2"/></td></tr>
				<tr><th>Linked to</th><td><input type="hidden" id="tm-link"/><input type="text" id="tm-link-l"/></td></tr>
			</table>
			<!-- YEAR -->
