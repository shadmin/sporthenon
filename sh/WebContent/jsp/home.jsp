...
<div id="home">
	...
	<div class="homecontent">
		...
		<div class="fieldset">
			...
			<div class="fscontent">
				<img src="img/bullet.gif" alt="-"/>&nbsp;<b>Nov. 29, 2013</b>&nbsp;-&nbsp;Version 0.5.0 Released&nbsp;(<a target="_blank" href="changelog.txt?v=<%=ConfigUtils.getProperty("version")%>">Change Log</a>)<br/><br/>
