...
CREATE TABLE "~NEWS"
(
  date_text character varying(20) NOT NULL,
...
ALTER TABLE "DRAW" ADD COLUMN id1_thd integer; 
ALTER TABLE "DRAW" ADD COLUMN id2_thd integer; 
ALTER TABLE "DRAW" ADD COLUMN result_thd varchar(40); 
