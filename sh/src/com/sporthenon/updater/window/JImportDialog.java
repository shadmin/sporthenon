...
public class JImportDialog extends JDialog implements ActionListener {
	...
	private JPanel getSettingsPanel() {
		...
		p.add(btn);
		jProcessButton = new JCustomButton("Process", "updater/ok.png", null);
