		...
		try {
			...
			for (Vector<String> v : vFile) {
				if (!isReprocess)
					...
					v.set(0, "");
				if (jTypeRS.isSelected())
					isError |= ImportUtils.processLineRS(i, vHeader, v, isUpdate, null);
				else if (jTypeDR.isSelected())
					isError |= ImportUtils.processLineDR(i, vHeader, v, isUpdate, null);
				else if (jTypeRC.isSelected())
					isError |= ImportUtils.processLineRC(i, vHeader, v, isUpdate, null);
